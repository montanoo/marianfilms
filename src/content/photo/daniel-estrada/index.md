...
columns:
  - width: 574
    rows:
      ...
      - [{ src: ./gallery/slide-3.jpg }]
      - [{ src: ./gallery/slide-6.jpg }]
      - [{ src: ./gallery/slide-8.jpg }]
  - width: 851
    align: end
    rows:
      - [{ src: ./gallery/slide-2.jpg, w: 0.506 }] # right-aligned → top gap, matches col-1 height
      - [{ src: ./gallery/slide-4.jpg }, { src: ./gallery/slide-5.jpg }] # pair
      - [{ src: ./gallery/slide-7.jpg }] # full width
      - [{ src: ./gallery/slide-9.jpg }] # full width
---
